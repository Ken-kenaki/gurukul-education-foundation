      ...
      <div className="container mx-auto px-4 py-12 -mt-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((stat, index) => (
            ...
            >
              <p className="text-2xl font-bold text-[#2C3C81]">{stat.value}</p>
          ...
          >
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-4">
                Malta's education system is based on the British model, offering
                internationally recognized qualifications. Higher education is
                divided between the University of Malta and the Malta College of
                Arts, Science and Technology (MCAST).
              </p>
              <p className="text-gray-600 mb-6">
                Most undergraduate programs take 3 years to complete (Bachelor's
                degrees), while postgraduate programs typically take 1-2 years.
            ...
            <div className="md:w-1/2 bg-gray-100 p-8 rounded-xl">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="text-[#2C3C81] mr-2">✓</span>
                  <span>EU-compliant qualifications recognized worldwide</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#2C3C81] mr-2">✓</span>
                ...
                <li className="flex items-start">
                  <span className="text-[#2C3C81] mr-2">✓</span>
                  <span>Strong emphasis on research and practical skills</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#2C3C81] mr-2">✓</span>
                  <span>
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span>
                    Letter of acceptance from a Maltese educational institution
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#C73D43] mr-2">•</span>
