    ...
    <div className="bg-white pt-15">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {highlights.map((item, index) => (
              ...
              >
                ...
                <p className="text-xl font-bold text-[#012169]">{item.value}</p>
              </motion.div>
            ))}
          </div>
        </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    during studies and unlimited during holidays.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-[#012169]">
      ...
      <section className="py-16 bg-gradient-to-r from-[#012169] to-[#E4002B] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Our MARA-registered agents can help you find the perfect course and
