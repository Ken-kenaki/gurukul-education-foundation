...
export default function Gallery() {
  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-br from-red-50 via-white to-purple-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-8 max-w-md mx-auto relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-red-500 focus:ring-red-500 outline-none shadow-sm"
          />
        </div>
            ...
            {filteredImages.map((img) => (
              <article
                ...
                className={`cursor-pointer group transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-red-500 ${
                  viewMode === "grid"
                    ? "bg-white border rounded-xl overflow-hidden shadow hover:scale-105"
                    : "bg-white border rounded-xl shadow p-4 flex items-center gap-4"
                }`}
        ...
        >
          ...
          >
            <button
              ...
              className="absolute top-4 right-4 bg-black/50 rounded-full p-2 border border-white/20 focus:outline-none focus:ring-2 focus:ring-red-600"
            >
