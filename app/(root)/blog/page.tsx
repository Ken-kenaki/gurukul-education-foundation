    ...
    <div className="bg-white">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                ...
                <span className="block text-blue-300">Education Potential</span>
              </h1>
      ...
      >
        ...
        <p className="text-lg text-center max-w-4xl mx-auto">
          Established in 2022 with offices in Kumaripati, Lalitpur and Kawasoti,
          Nawalparasi, Gurukul Education Foundation is your trusted partner for
          international education. We specialize in helping Nepalese students
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            >
              ...
              <p className="mt-2">High success rate with expert instructors</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-16 bg-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Visit our offices in Kumaripati or Kawasoti, or contact us online to
