        ...
        <div className="container mx-auto px-4 py-8">
          ...
          >
            ...
            <p className="text-lg text-[#2C3C81]/80 max-w-3xl mx-auto">
              Discover amazing study opportunities in South Korea, Australia,
              Japan, UK, and Malta
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="space-y-4">
                      <div className="flex items-start">
                        <Calendar
                          size={20}
                          className="mr-3 text-[#C73D43] mt-1"
                        />
                        <div>
                  ...
                  {selectedCountry.description && (
                    <div className="mb-6">
                      <h3 className="font-medium text-[#2C3C81] mb-2">
                        About Studying in {selectedCountry.name}
                      </h3>
